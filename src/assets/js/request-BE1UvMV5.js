import { j as qe, A as se } from "./index-HHlgu3jn.js";
/* empty css             */
function ye(e, t) {
    return function () {
...
function ze(e) {
    let t;
    return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? t = ArrayBuffer.isView(e) : t = e && e.buffer && Ee(e.buffer),
        t
}
const Je = q("string")
    , R = q("function")
    ...
    , Qe = A("URLSearchParams")
    , Ze = e => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Ye = (e, t, n, { allOwnKeys: r } = {}) => (B(t, (s, o) => {
    ...
    e)
    , et = e => (e.charCodeAt(0) === 65279 && (e = e.slice(1)),
        e)
    , tt = (e, t, n, r) => {
    ...
    , ot = (e => t => e && t instanceof e)(typeof Uint8Array < "u" && Z(Uint8Array))
    , it = (e, t) => {
    ...
    , ct = A("HTMLFormElement")
    , ut = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function (n, r, s) {
...
const Et = e => {
    ...
    , bt = A("AsyncFunction")
    , wt = e => e && (I(e) || R(e)) && R(e.then) && R(e.catch)
    , a = {
        isArray: C,
        isArrayBuffer: Ee,
        isBuffer: Me,
...
Object.defineProperty(Te, "isAxiosError", {
    value: !0
});
m.from = (e, t, n, r, s, o) => {
    ...
    function l(f, d, b) {
        ...
        if (f && !b && typeof f == "object") {
            if (a.endsWith(d, "{}"))
                d = r ? d : d.slice(0, -2),
                    f = JSON.stringify(f);
            else if (a.isArray(f) && Rt(f) || (a.isFileList(f) || a.endsWith(d, "[]")) && (w = a.toArray(f)))
                return d = xe(d),
                    w.forEach(function (x, He) {
                        !(a.isUndefined(x) || x === null) && t.append(i === !0 ? ae([d], He, o) : i === null ? d : d + "[]", h(x))
                    }),
                    !1
        }
        return G(f) ? !0 : (t.append(ae(b, d, o), h(f)),
            !1)
    }
    const u = []
        , E = Object.assign(Ot, {
...
const Ce = {
    ...
    , Tt = typeof URLSearchParams < "u" ? URLSearchParams : Y
    ...
    , Pt = (e => Fe && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(typeof navigator < "u" && navigator.product)
    , Ct = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function"
...
const te = ee
    , Ut = a.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"])
    , kt = e => {
        const t = {};
        let n, r, s;
        return e && e.split(`
`).forEach(function (i) {
            s = i.indexOf(":"),
                ...
                !(!n || t[n] && Ut[n]) && (n === "set-cookie" ? t[n] ? t[n].push(r) : t[n] = [r] : t[n] = t[n] ? t[n] + ", " + r : r)
        }),
            t
    }
    , le = Symbol("internals");
...
class z {
    ...
    set(t, n, r) {
        ...
        return a.isPlainObject(t) || t instanceof this.constructor ? i(t, n) : a.isString(t) && (t = t.trim()) && !Ht(t) ? i(kt(t), n) : t != null && o(n, t, r),
            this
    }
    get(t, n) {
        if (t = F(t),
...
const Vt = O.hasStandardBrowserEnv ? function () {
            ...
            if ("onloadend" in u ? u.onloadend = S : u.onreadystatechange = function () {
                ...
                u.ontimeout = function () {
                    ...
                    e.timeoutErrorMessage && (b = e.timeoutErrorMessage),
                        r(new m(b, w.clarifyTimeoutError ? m.ETIMEDOUT : m.ECONNABORTED, e, u)),
                        u = null
                }
                ,
                O.hasStandardBrowserEnv && (c && a.isFunction(c) && (c = c(e)),
                    c || c !== !1 && Vt(E))) {
                const d = e.xsrfHeaderName && e.xsrfCookieName && zt.read(e.xsrfCookieName);
                d && o.set(e.xsrfHeaderName, d)
            }
            s === void 0 && o.setContentType(null),
                "setRequestHeader" in u && a.forEach(o.toJSON(), function (b, w) {
    ...
    , Le = {
        getAdapter: e => {
            ...
            for (let o = 0; o < t; o++) {
                ...
                let i;
                if (r = n,
                    !vt(n) && (r = X[(i = String(n)).toLowerCase()],
                        r === void 0))
...
function pe(e) {
    return W(e),
        ...
        Le.getAdapter(e.adapter || te.adapter)(e).then(function (r) {
            return W(e),
...
y.default = y;
const je = y.create({
    baseURL: "http://49.234.52.28:9098",
    timeout: 3e4
});
je.interceptors.request.use(e => {
    e.headers["Content-Type"] = "application/json;charset=utf-8";
    const t = JSON.parse(localStorage.getItem("xm-user") || "{}");
    return e.headers.token = t.token || "",
        e
}
    , e => Promise.reject(e));
